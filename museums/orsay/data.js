...
window.HUNT = {
  ...
  items: [
    ...
    {
      id: "card-players",
      title: "Men Playing a Game",
      find: "What game are the men playing? Can you find their pipes and the bottle?",
      where: "With the Cézanne paintings.",
      fact: "Paul Cézanne painted these quiet card players many times. He loved shapes like apples and triangles.",
      color: "#6d6875",
      icon: "🃏",
    },
  ],
